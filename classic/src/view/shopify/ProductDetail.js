...
Ext.define('August.view.shopify.ProductDetail',{
    extend: 'Ext.tab.Panel',

    requires: [
        'August.view.shopify.ProductDetailController',
        'August.view.shopify.ProductDetailModel'
    ],

    controller: 'shopify-productdetail',
    viewModel: {
        type: 'shopify-productdetail'
    },

    alias: 'widget.shopify-productdetail',        
