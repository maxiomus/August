...
Ext.define('August.view.production.ChildPO',{
    extend: 'Ext.grid.Panel',

    requires: [
        'August.view.production.ChildPOController',
        'August.view.production.ChildPOModel'
    ],
    ...
    columns: [
        ...
        { xtype:'datecolumn', text: 'Order Date' , dataIndex: 'orderDate', width: 88, format: 'Y-m-d'},
        { xtype:'datecolumn', text: 'D. ETA' , dataIndex: 'nvlt_pod_etadate', width: 88, format: 'Y-m-d'},
        ...
        { xtype:'datecolumn', text: 'Start Date' , dataIndex: 'startDate', width: 88, format: 'Y-m-d'},
        { xtype:'datecolumn', text: 'Cancel Date' , dataIndex: 'cancelDate', width: 88, format: 'Y-m-d'},
        { xtype:'datecolumn', text: 'ETA Date' , dataIndex: 'etaDate', width: 88, format: 'Y-m-d'},
        { xtype:'datecolumn', text: 'Ship Date' , dataIndex: 'SHIPDATE', width: 88, format: 'Y-m-d'},
        ...
        { xtype:'datecolumn', text: 'Create Date' , dataIndex: 'createDate', width: 88, format: 'Y-m-d'},
