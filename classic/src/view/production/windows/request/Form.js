...
Ext.define('August.view.production.windows.request.Form',{
    extend: 'Ext.window.Window',

    alias: 'widget.windows-request-form',

    requires: [
        'August.view.production.windows.request.FormController',
        'August.view.production.windows.request.FormModel',
        'Ext.ux.IFrame'
    ],
