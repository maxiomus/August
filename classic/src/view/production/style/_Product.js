 ...
 */
Ext.define('August.view.production.style._Product',{
    extend: 'August.view.Viewer',

    requires: [
        'August.view.production.style._ProductController',
        'August.view.production.style._ProductModel',
