...
Ext.define("August.view.Display",{
    extend: "Ext.panel.Panel",

    alias: 'widget.display',

    requires: [
        "August.view.DisplayController",
        "August.view.DisplayModel"
    ],
    ...
    */
    ...
    loadIframe: function(){
        var me = this,
            d = Ext.util.Format,
            srcPath = d.format('../services/PowPreviewPrint.ashx?ID={0}', me.active.data.orderId);
