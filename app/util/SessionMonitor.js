 ...
 * logged out.
 */
 Ext.define('August.util.SessionMonitor', {
    singleton: true,
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        buttons: [{
            ...
            handler: function() {
                Ext.TaskManager.stop(August.util.SessionMonitor.countDownTask);
                August.util.SessionMonitor.window.hide();
