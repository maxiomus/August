/**
 * Created by tech on 5/7/2019.
 */
 Ext.define('Ext.ux.calendar.form.AbstractForm', {
    ...
    config: {
        ...
        hideDescField: {
            ...
            itemId: 'hideDesc',
            name: 'hideDesc',
            boxLabel: 'Hide Description',
            hideEmptyLabel: false,
            handler: 'onHideDescChange'
        },
    ...
    createItems: function() {
        ...
        if(!checkCt.items){
            checkCt.items = [me.getAllDayField(), me.getHideDescField()];
        }
    ...
    privates: {
        ...
        checkHide: function() {
            var checked = this.down('#hideDesc').checked;

            this.down('#description').setHidden(checked);
        },
