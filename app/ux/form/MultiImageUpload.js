...
Ext.define('Ext.ux.form.MultiImageUpload', {
                        ...
                        render: function(c){
                            c.getEl().on('paste', function(e){
                                ...
                                if (blob != null) {
                                    ...
                                    August.util.Utils.showErrorMsg('You are copying non-Image type! Please use Image type only.')
                                }
    ...
    addFilesToQueue: function(fieldset, files) {
        ...
        if(!files[0].name){
            me.blobToFile(files[0], August.util.Utils.generateGUID()+'.'+files[0].type.split('/').pop())
        }
