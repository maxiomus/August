 ...
 */
Ext.define('Ext.ux.form.field.SearchNumber', {
    ...
    onClearClick: function () {
        ...
        if (me.hasSearch) {
            ...
            delete filter.fields.eq.value;
            filter.filter.eq.setValue({});
    ...
    onSearchClick: function () {
        ...
        if (value != null) {
            ...
            filter.filter.eq.setValue(value);
