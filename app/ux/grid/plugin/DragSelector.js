...
Ext.define('Ext.ux.grid.plugin.DragSelector', {
    ...
    fillAllRegions: function()
    {
        ...
        Ext.each(me.view.all.elements, function(el)
        {
            //console.log(el);
    ...
    fillRegions: function()
    {
        ...
        for(i = 0; i <= this.view.all.endIndex; i++){
            el = Ext.get(this.view.all.elements[i]);
            //console.log(el);
            rs.push(el.getRegion());
        }

        // original this.view.all is not Ext.dom.CompositeElement
        // instead Ext.dom.NodeCaches
        // new Ext.dom.CompositeElement(this.view.all.elements) not working
        // since it is not iterable and this class make it to Array of elements...
        // console.log(Ext.isIterable(this.view.all.elements));
    ...
    onBeforeStart: function(e)
    {
        ...
        if(e.getX() > this.view.el.getX() + this.view.el.dom.clientWidth - 20)
        {
            return false;
        }
