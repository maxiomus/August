Ext.define('August.view.settings.product.windows.mapping.UploadColors',{
    ...
    alias: 'widget.windows-mapping-uploadcolors',        
    ...
    header: {
        title: 'Color Mapping Import',
        iconCls: 'x-fa fa-arrows-down',
        titlePosition: 0,
        titleAlign: 'left'
    },
        ...
        me.dockedItems = [{
            ...
            items: ['->', {
                ...
                handler: function(btn){
                    me.fireEvent('importclick', btn, me);
                }
            },{
                action: 'close',
                text: 'Close',
