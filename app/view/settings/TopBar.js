...
Ext.define('August.view.settings.TopBar',{
    extend: 'Ext.toolbar.Toolbar',

    requires: [
        'August.view.settings.TopBarController',
        'August.view.settings.TopBarModel'
    ],

    alias: 'widget.settings-topbar',

    controller: 'settings-topbar',
    viewModel: {
        type: 'settings-topbar'
    },
