Ext.define('August.view.settings.company.users.List', {
        ...
        */
        {
            ...
            items: [{
                ...
                handler: function(view, rowIndex, colIndex) {
                    ...
                    //location.href = '/WebApp/api/Wips/Export/excel?' + Ext.Object.toQueryString({headers: headers.toString()}) + (!Ext.isEmpty(data) ? '&' + Ext.Object.toQueryString({filters: Ext.JSON.encodeValue(data)}) : '');
                    processMask.show();

                    Ext.Ajax.request({
                        url: '/WebApp/api/Email/' + rec.id,
                        method: 'PUT',
                        timeout: 900000,
                        jsonData: rec.data,
