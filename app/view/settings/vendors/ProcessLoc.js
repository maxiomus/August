...
Ext.define('August.view.settings.vendors.ProcessLoc',{
    extend: 'Ext.tab.Panel',

    requires: [
        'August.view.settings.vendors.ProcessLocController',
        'August.view.settings.vendors.ProcessLocModel',
        'August.model.ProcessLoc'
    ],
