Ext.define('August.view.settings.DefaultModel', {
        ...
        areas: { 
            ...
            root: { 
                ...
                children: [{
                    ...
                    text:'Shopify', 
                    routeId:'shopify-default', 
                    expanded:true, 
                    children:[{
                        leaf:true, 
                        text:'Product Images', 
                        routeId:'shopify-productimage'
                    }]
                },{
                    text:'Tasks', 
                    ...
                    children:[{
                        leaf:true, 
                        text:'Process Location', 
                        routeId:'vendors-processloc'
                    },{
                        leaf:true, 
                        text:'Process Type', 
                        routeId:'vendors-processtype'
                    },{
                        leaf:true, 
                        text:'Vendor Type', 
                        routeId:'vendors-vendortype'
                    }]
                }]
            }
        },             
