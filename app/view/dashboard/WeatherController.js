Ext.define('August.view.dashboard.WeatherController', {
    ...
    init: function(view){
        ...
        var vm = this.getViewModel(),
            rec = Ext.create('August.model.weather.City', {
                id: 5368361,
                name: 'Los Angeles',
                country: 'US',
    ...
    onLoad: function(store, records, success){
        /*
         ...
         //var searchtext = grid.down('toolbar > searchtext')[0];
        ...
        Ext.Msg.show({
            ...
            fn: function(btn){
                if(btn === 'yes'){
                    ...
                    var climateOption = Ext.create('August.model.UserOption', {
            ...
            buttons: [{
                ...
                handler: function(){
                    ...
                    if(form.isValid()){
                        ...
                        August.model.weather.Climate.load(form.getValues().cityId, {
