...
Ext.define('August.view.purchase.windows.PrintPO',{    
    extend: 'Ext.window.Window',

    requires: [
        'August.view.purchase.windows.PrintPOController',
        'August.view.purchase.windows.PrintPOModel'
    ],

    alias: 'widget.purchase-windows-printpo',

    controller: 'purchase-windows-printpo',
    viewModel: {
        type: 'purchase-windows-printpo'
    },        
        ...
        var headerTpl = new Ext.XTemplate(
            ...
            '<table class="print-po-view">',
                '<tr>',
                    ...
                    '</td>',                    
                    '<td rowspan="3">',                        
                        '<img src="https://endlessrose.net:9443/StyleImages/200xImages/{imageName}" width="209" height="316" ',
                            'onerror="this.onerror=null;this.src=\'https://endlessrose.net:9443/StyleImages/{imageName}\';" ',
                        '/>',
                    '</td>',
                '</tr>',        
                '<tr>',
