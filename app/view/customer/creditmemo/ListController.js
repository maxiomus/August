Ext.define('August.view.customer.creditmemo.ListController', {
    ...
    alias: 'controller.customer-creditmemo',
    ...
    onActionNew: function(b){        
        ...
        */
        me.redirectTo("customer-creditmemo/new");   
    },
    ...
    onActionEdit: function(b, c){
        ...
        var me = this,
            ...
            grid = layout.lookupReference('cmGrid'),
            rec = grid.getSelection()[0];
        
        me.redirectTo("customer-creditmemo/edit/" + rec.data.CMNO);
    ...
    onActionRefresh: function(b, c){
        this.getStore("customercms").reload();
    },
    ...
    onSelect: function(sm, rec, index, eOpts){
        ...
        //console.log(rec);
        this.redirectTo('customer-creditmemo/default/' + rec.get('CMNO'));
    },
