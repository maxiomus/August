...
Ext.define('August.view.customer.invoice.List', {    
    extend: 'August.view.Viewer',

    requires: [
        'August.view.customer.invoice.ListController',
        'August.view.customer.invoice.ListModel',        
        'August.view.customer.invoice.Form',
        'August.plugin.grid.Exporter'        
    ],

    alias: "widget.customer-invoice",
    ...
    initComponent: function(){
        ...
        var g=this.lookupReference("multiview"),
            j=g.lookupReference("invoiceGrid"),
            ...
            [{
                ...
                handler: function(b){
                    j.saveDocumentAs({
                        type: 'xlsx',
                        title: 'Invoices List',
                        fileName: 'Invoices ' + Ext.Date.format(new Date(), 'Y-m-d')
                    });
                }
            }]
        );
    ...
    buildBottomBar: function(){
        ...
        b.on('afterrender', function(c, e){
            var store = this.getViewModel().getStore("customerinvoices");
