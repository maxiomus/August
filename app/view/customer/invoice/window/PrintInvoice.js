...
Ext.define('August.view.customer.invoice.window.PrintInvoice',{
    
    extend: 'Ext.window.Window',

    requires: [
        'August.view.customer.invoice.window.PrintInvoiceController',
        'August.view.customer.invoice.window.PrintInvoiceModel'
    ],

    alias: 'widget.invoice-window-printinvoice',

    controller: 'invoice-window-printinvoice',
    viewModel: {
        type: 'invoice-window-printinvoice'
    },        
        ...
        var headerTpl = new Ext.XTemplate(
                ...
                '<tr>',
                    '<td>',                        
                        '<div class="item-boxer">',
                            ...
                            '<div class="item-boxer">',
                                '<div class="box-row">',
                                    '<div class="box" style="width:380px; height:60px;text-align:center; font-size:40px; font-weight:bold;">Invoice</div>', 
                                ...
                                '<div class="box-row">',                                    
                                    '<div class="item-boxer ab" style="margin-left:70px;height:30px;">',
                                        '<div class="box rb" style="font-size:20px;font-weigh`  t:bold;width:120px;text-align:center;">Invoice No.</div>',                                        
                                        '<div class="box nb" style="font-size:20px;font-weight:bold;width:120px;text-align:center;">{invoiceno}</div>',                                    
                                    '</div>',                                       
                                    '<div class="box nb">',                                                                       
                                        ...
                                        '<svg class="barcode" jsbarcode-value="{invoiceno}" jsbarcode-displayValue="false" jsbarcode-height="56" jsbarcode-margin="0" jsbarcode-textmargin="0"></svg>',                                    
                                    '</div>',                      
                                '</div>',
                            '</div>',                                                                 
                    ...
                    '</td>',                    
                    '<td rowspan="3">',                        
                        '<img src="https://endlessrose.net:9443/StyleImages/200xImages/{imageName}" width="209" height="316"></img>',
                    '</td>',
                '</tr>',        
                '<tr>',
                    '<td>',
                            ...
                            '<div class="box-row">',                                    
                                '<div class="box ab">',
                                    '<div class="item-boxer">',
                                        ...
                                        '<div class="box rb" style="width:160px;">{division}</div>',                                        
            ...
            {   
                getSrcPath: function(a,b){                                                                       
                    ...
                    return url = 'https://endlessrose.net:9443/StyleImages/200xImages/' + item.style + '_' + item.color.replace('/', '-') + '_front.jpg';                                                      ;
    ...
    cssTemplate: function() {
        return ''.concat(                                      
            '@page { size: 11in 8.5in; margin-top: 20px; }',
