 ...
 */
Ext.define('August.view.production.windows.style.Upload', {
    extend: 'Ext.window.Window',

    requires: [
        'August.view.production.windows.style.UploadController',
        'August.view.production.windows.style.UploadModel'
    ],

    alias: 'widget.windows-style-upload',

    controller: "windows-style-upload",
    viewModel: {
        type: "windows-style-upload"
    },
    ...
    initComponent: function() {
        ...
        */
        ...
        var remoteComponents = Ext.create('August.store.Components', {
            fields: [{
                name: 'id',
                sortType: 'asUCString'
            },{
            ...
            items: [{
                ...
                items: [{
                    ...
                    columns: [{
                        ...
                        xtype: 'actioncolumn',
                        text: '<i class="x-far fa-times-circle"></i>',
