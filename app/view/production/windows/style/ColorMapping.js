 ...
 */
 Ext.define('August.view.production.windows.style.ColorMapping',{
    extend: 'Ext.window.Window',

    requires: [
        'August.view.production.windows.style.ColorMappingController',
        'August.view.production.windows.style.ColorMappingModel',        
