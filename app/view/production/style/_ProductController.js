Ext.define('August.view.production.style._ProductController', {
    ...
    onOpenUploadClick: function(){
        ...
        this.showWindow(rec, 'windows-style-upload', function(type){
            ...
            wvm.setStores({
                fileStore: {
                    model: 'August.model.sample.Smph',
                    listeners: {
    ...
    onSaveCopy: function(b, c){
        ...
        */
        ...
        /*
        August.model.product.Product.load(parseInt(sRec.getId(),10), {
