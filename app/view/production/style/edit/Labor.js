...
Ext.define('August.view.production.style.edit.Labor',{
    extend: 'Ext.grid.Panel',

    requires: [
        'August.view.production.style.edit.LaborController',
        'August.view.production.style.edit.LaborModel'
    ],

    alias: 'widget.style-edit-labor',

    /*
    controller: 'production-sample-edit-labor',
    viewModel: {
        type: 'production-sample-edit-labor'
    },
    */
