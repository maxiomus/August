...
Ext.define('August.view.production.style.edit.CostView',{
    extend: 'Ext.view.View',

    requires: [
        'August.view.production.style.edit.CostViewController',
        'August.view.production.style.edit.CostViewModel'
    ],
