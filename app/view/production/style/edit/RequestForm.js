...
Ext.define('August.view.production.style.edit.RequestForm',{
    extend: 'Ext.form.Panel',

    requires: [
        'August.view.production.style.edit.RequestFormController',
        'August.view.production.style.edit.RequestFormModel'
    ],
