...
Ext.define('August.view.production.style.edit.Detail',{
    extend: 'Ext.form.Panel',

    requires: [
        'August.view.production.style.edit.DetailController',
        'August.view.production.style.edit.DetailModel',
        'August.view.production.style.edit.Material',
        'August.view.production.style.edit.Labor'
    ],
