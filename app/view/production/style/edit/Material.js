...
Ext.define('August.view.production.style.edit.Material',{
    extend: 'Ext.grid.Panel',

    requires: [
        'August.view.production.style.edit.MaterialController',
        'August.view.production.style.edit.MaterialModel'
    ],

    alias: 'widget.style-edit-material',

    
    controller: 'style-edit-material',
    viewModel: {
        type: 'style-edit-material'
    },
