Ext.define('August.view.production.WIPController', {
    extend: 'Ext.app.ViewController',

    requires: [
        'August.model.production.WIP'
        //'August.model.production.Task',
        //'August.model.production.ChildPO'
    ],
    ...
    onClearFilters: function(b){
        var me = this,
            ...
            searchgrid = topbar.lookupReference('searchgrid'),
