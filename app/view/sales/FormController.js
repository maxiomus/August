        ...
        me.win = view.add({
            ...
            viewModel: {
                ...
                links: {
                    ...
                    theItem: record || {
                        type: 'sales.OrderItem',
                        create: {
                            orderdate: view.getViewModel().get('theOrder').data.orderDate,
                            wh: view.getViewModel().get('theOrder').data.warehouse,
