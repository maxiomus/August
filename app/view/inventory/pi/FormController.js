Ext.define('August.view.inventory.pi.FormController', {
     ...
     */
    requires: [
        'August.model.inventory.PIH',
        'August.model.inventory.PI',
        //'August.model.PIRoll',
        'August.view.inventory.pi.Window'
    ],
                ...
                batch.on({
                    operationcomplete: function(batch, op){
                        ...
                        if(!Ext.isEmpty(objResp)){
                            ...
                            console.log('PI - Batch Operation Complete', objResp);
