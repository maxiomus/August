...
Ext.define('August.view.inventory.pi.Physical',{
    extend: 'August.view.Viewer',

    requires: [
        'August.view.inventory.pi.PhysicalController',
        'August.view.inventory.pi.PhysicalModel',
        'August.view.inventory.pi.Form',        
